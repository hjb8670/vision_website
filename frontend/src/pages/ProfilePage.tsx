        ...
        {editingBio ? (
          <div className="space-y-3">
            <textarea
              ...
              className="w-full bg-sunken border border-border rounded-md px-3 py-2 text-sm text-text-primary placeholder:text-text-secondary focus:outline-none focus:border-accent-primary resize-none"
            />
            <div className="flex gap-2 justify-end">
              <button
                type="button"
                onClick={() => setEditingBio(false)}
                className="px-4 py-1.5 rounded-full text-sm font-medium text-text-secondary hover:bg-overlay-1 transition-colors"
              >
