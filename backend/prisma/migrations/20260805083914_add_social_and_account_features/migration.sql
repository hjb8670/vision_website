-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('MARKET', 'SOCIAL', 'SYSTEM');

-- CreateEnum
CREATE TYPE "ReportContentType" AS ENUM ('POST', 'PREDICTION', 'COMMENT', 'USER');

-- CreateEnum
CREATE TYPE "ReportReason" AS ENUM ('SPAM', 'HARASSMENT', 'MISINFORMATION', 'ADULT_CONTENT', 'OTHER');
